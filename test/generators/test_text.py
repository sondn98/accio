...
from models.types import TextConfig
...
def test_text():
    ...
    d_tt2 = TextGenerator(TextConfig(type="text", max_length=100), SEED)
    ...
    d_tt3 = TextGenerator(TextConfig(type="text", max_length=100, const="Lorem Ipsum"), SEED)
